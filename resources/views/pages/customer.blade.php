    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          >
            ...
            <a href="{{route('create-form')}}" class="btn btn-primary add-list"
              ><i class="las la-plus"></i>Thêm Mới Khách Hàng</a
            >
          </div>
        </div>
        <div class="col-lg-12">
                ...
                <tr data-id="{{ $data->id }}">
                    ...
                    <div class="d-flex align-items-center list-action">
                      <a
                        ...
                        data-name="{{$data->hoTen}}" data-sex="{{$data->gioiTinh}}" data-email="{{$data->email}}"
                        data-phone="{{$data->sdt}}" data-birthday="{{$data->ngaySinh}}" data-address="{{$data->diaChi}}" data-desc="{{$data->desc}}"
