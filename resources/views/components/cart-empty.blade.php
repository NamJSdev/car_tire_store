<div class="empty-cart" style="width: 50vw; margin: 0 auto; text-align: center;">
    <svg viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="max-width: 60%; padding: 5rem 3rem;">
    ...
    <h3 style="font-size: 2rem; line-height: 2rem; margin: 0; padding: 0; font-weight: 600;">Dữ Liệu Đang Trống</h3>
    <p style="color: rgba(0,0,0,0.5); font-size: 18px; line-height: 24px; max-width: 80%; margin: 1.25rem auto 0 auto;">Hiện chưa có bản ghi nào. Thông tin sẽ sẽ được cập nhật khi có dữ liệu...</p>
</div>